...
I enjoy building software that combines intelligent automation with scalable system design, focusing on performance, clean architecture, and practical user experiences.
...
### Tools
<img src="https://skillicons.dev/icons?i=python,java,javascript,react,tailwind,fastapi,nodejs,express,postgres,mongodb,mysql,docker,git,github,vscode"/>
...
AI-powered legal document intelligence platform that analyzes contracts, identifies risks, extracts critical clauses, and generates explainable summaries using LLMs.

**Tech**
FastAPI • React • Python • Groq • LLMs
**Stack:** FastAPI • React • PostgreSQL • Groq • Python
...
Predictive maintenance platform for industrial equipment with telemetry monitoring, health analytics, anomaly detection, and failure prediction.

**Tech**
FastAPI • React • PostgreSQL • Machine Learning
**Stack:** FastAPI • React • PostgreSQL • Machine Learning
...
## 🏥 Hospital Management System
Java web application for managing patients, appointments, doctors, and hospital workflows.
...
*"Good software solves problems. Great software solves them simply."*
